package com.appleframework.persistent.mybatis.interceptor;
...
import com.appleframework.persistent.mybatis.page.Query;
import com.appleframework.persistent.mybatis.util.SystemUtil;
...
public class PaginationInterceptor implements Interceptor {
	...
	public Object intercept(Invocation ivk) throws Throwable {
		...
		BaseStatementHandler delegate 
			= (BaseStatementHandler) SystemUtil.getValueByFieldName(statementHandler, "delegate");
		MappedStatement mappedStatement 
			= (MappedStatement) SystemUtil.getValueByFieldName(delegate, "mappedStatement");
