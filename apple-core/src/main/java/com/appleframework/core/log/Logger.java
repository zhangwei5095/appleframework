 ...
 * Please note:
 * <p/>
 * 1) this interface does not define method isSomeLevelEnabled(). Implementation
 * will handle this at runtime, so you should not worry about this.
 * <p/>
 * 2) each method with var args parameters list uses String.format, so actually
 * independent of logging frameworks.
 * 
 * @author Cruise.Xu
 */
