...
public final class RuntimeUtility {
	...
	/**
	 * you can find runtime mode using this property(it can be
	 * prod/uat/dev/junit).
	 */
	 ...
	 * streams. the streams specified are not closed automatically.
	 * <p/>
	...
	/**
	 * @return actual runtime mode or <code>NULL</code> if runtime_mode system
	 *         property is not set.
	 */
