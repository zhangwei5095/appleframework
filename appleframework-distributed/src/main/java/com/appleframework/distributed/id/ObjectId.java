...
public class ObjectId implements Comparable<ObjectId>, java.io.Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(serialVersionUID, that.serialVersionUID) &&
                Objects.equal(LOGGER, that.LOGGER) &&
                Objects.equal(_time, that._time) &&
                Objects.equal(_machine, that._machine) &&
                Objects.equal(_inc, that._inc) &&
                Objects.equal(_new, that._new) &&
                Objects.equal(_nextInc, that._nextInc) &&
                Objects.equal(_genmachine, that._genmachine);
    }
