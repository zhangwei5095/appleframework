...
/**
 * <pre>
 *    构建{@link com.appleframework.rop.RopRequestContext}实例
 * </pre>
 *
 * @author 陈雄华
 * @version 1.0
...
public class ServletRequestContextBuilder implements RequestContextBuilder {
    ...
    /**
     * 将{@link HttpServletRequest}的数据绑定到{@link com.appleframework.rop.RopRequestContext}的{@link com.appleframework.rop.RopRequest}中，同时使用
     * JSR 303对请求数据进行校验，将错误信息设置到{@link com.appleframework.rop.RopRequestContext}的属性列表中。
     *
